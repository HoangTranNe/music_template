...
function MenuLeft(){
    return (
        ...
        <div className="logo" style={{zIndex: "0"}}>
            <a href='../Playlists'>
                <img src="/static/img/logo.png" width="70%" className="mb-3" alt="Logo" />
            </a>
        </div>
        <div className="mb-3 ps-1" style={{color: "#B3B3B3"}}>
            <img src="/static/img/icon-home.png" width="30px" height="30px" alt="Home Icon"/>
            <span className="ms-3 fs-4 align-bottom">Home</span>
        </div>
        <div className="mb-3 ps-1" style={{color: "#B3B3B3"}}>
            <img src="/static/img/icon-search.png" width="30px" height="30px" alt="Search Icon"/>
            <a href='./Search' style ={{
                color: "#B3B3B3",
                textDecoration: "none"
        ...
        <div className="mb-5 ps-1" style={{color: "#B3B3B3"}}>
            <img src="/static/img/icon-lib.png" width="30px" height="30px" alt="Library Icon"/>
            <span className="ms-3 align-bottom">Your Library</span>
        </div>
        <div className="mb-3 ps-1" style={{color: "#B3B3B3"}}>
            <img src="/static/img/playlist.png" width="30px" height="30px" alt="Playlist Icon"/>
            <span className="ms-3 align-bottom">Create Playlist</span>
        </div>
        <div className="mb-3 ps-1" style={{color: "#B3B3B3"}}>
            <img src="/static/img/icon-like.png" width="30px" height="30px" alt="Liked Songs Icon"/>
        ...
        <div className="mt-auto pt-3 pb-3 ps-2">
            ...
            <div>
                <button className="btn btn-outline-secondary d-flex align-items-center" style={{borderRadius: "25px"}}>
                    <img src="/static/img/icon-english.png" className="me-2" alt="English Language Icon"/>
